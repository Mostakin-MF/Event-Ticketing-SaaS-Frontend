...
import { X, Loader2, Building2, Globe, Palette, ShieldCheck, Zap, RefreshCw } from 'lucide-react';
    ...
    useEffect(() => {
        if (tenant) {
            setFormData({
                name: tenant.name || '',
                slug: tenant.slug || '',
                primaryColor: tenant.brandingSettings?.primaryColor || '#10b981',
                ...
                <div className="bg-[#022c22] p-8 text-white relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h3 className="text-xl font-black uppercase tracking-tight">Modify Matrix</h3>
                                <p className="text-emerald-100/60 text-[10px] font-black uppercase tracking-[0.2em]">Updating Deployment Environment</p>
                            </div>
                        </div>
